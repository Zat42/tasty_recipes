defmodule TastyRecipesWeb.Router do
  use TastyRecipesWeb, :router

  import TastyRecipesWeb.Html.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {TastyRecipesWeb.LayoutView, :root}
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      pipe_through :browser
      live_dashboard "/dashboard", metrics: TastyRecipesWeb.Telemetry
    end
  end

  ## Authentication routes

  scope "/html", TastyRecipesWeb.Html, as: :html do
